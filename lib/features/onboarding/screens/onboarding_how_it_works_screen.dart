                ...
                Column(
                  children: [
                    ...
                    Expanded(
                      flex: 4,
                      child: Center(
                        child: _HeroImageWithIcons(maxSize: width * 0.85),
                      ),
                    ),
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            // Description
                            Text(
                              'Our AI assistant makes the calls, handles\nthe back-and-forth, and syncs everything\ndirectly to your calendar.',
                              textAlign: TextAlign.center,
...
class _HeroImageWithIcons extends StatefulWidget {
  final double maxSize;

  const _HeroImageWithIcons({required this.maxSize});

  @override
  State<_HeroImageWithIcons> createState() => _HeroImageWithIconsState();
}

class _HeroImageWithIconsState extends State<_HeroImageWithIcons>
  ...
  @override
  Widget build(BuildContext context) {
    final orbDiameter = widget.maxSize * 0.90;
    ...
    return Container(
      ...
      child: Material(
        ...
        child: InkWell(
          onTap: () {
            Navigator.of(context).pushReplacement(
              fadeSlideRoute(const OnboardingStayInControlScreen()),
            );
          },
          borderRadius: BorderRadius.circular(16),
          child: const Center(
